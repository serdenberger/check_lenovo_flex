...
# modified by Silvio Erdenberger, serdenberger@lenovo.com 17.11.2017
# change filename to check_lenovo_flex.py
# there are several changes to the IBM Bladecenter
# changes in version 1.1
# add possibility to a Privacy Password for authPriv in snmp_security_level
# select the required paramater depending on --snmp_security_level
# expand the fans to 10 fans
# chassis-status to flex adjusted 
#  
# system-health to flex adjusted
